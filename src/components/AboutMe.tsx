                ...
                <div className="flex flex-col gap-4 mt-16">
                    <div className="flex flex-col md:flex-row gap-7 justify-between">
                        ...
                        <div className="flex flex-col gap-7 lg:m-24">
                            ...
                            <div className="mb-5 sm:text-2xl text-gray-500"><span className="font-bold text-black">Nick Richardson</span> - specialist in Frontend development. Clear code is my passion. Solving issues through negotiations</div>
