export const GetInTouchButton = (props: { customStyles: string; }) => {
    return (
        <>
            <button className={props.customStyles+" flex flex-row border rounded-3xl p-2 pt-3 pb-3 justify-center items-center gap-2 text-white bg-lavender border-lavender max-w-48 font-bold"}>Get in touch
